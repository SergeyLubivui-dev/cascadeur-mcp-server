"""Tools Pro launcher — a button window (in-app) that opens the other actions.
...
Each action is also its own "Tools Pro.*" command.
"""
...
def command_description():
    return ("MCP Tools Pro: rig a Mixamo model, retarget animation, physics-fill "
            "in-betweens, and export Unity-ready animation clips.")
